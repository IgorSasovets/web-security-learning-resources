...
Here is a list of applications that you can use to practise your skills in a safe manner.

- [bWAPP](http://www.itsecgames.com/download.htm)
- [DVWA](https://dvwa.co.uk/)
- [dvxte](https://github.com/davevs/dvxte)
- [mutillidae](https://github.com/webpwnized/mutillidae)
- [ninjasworkout](https://github.com/effortlessdevsec/ninjasworkout)
